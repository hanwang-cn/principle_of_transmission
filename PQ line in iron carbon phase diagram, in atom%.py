...
a = (0, 0.0025, 0.005, 0.01, 0.015, 0.02, 0.025, 0.03, 0.035, 0.04, 0.045,
     0.05, 0.055, 0.07, 0.085, 0.1, 0.104)
y = (25, 444, 484, 540, 567, 590, 610, 622, 636, 644, 652, 660, 666, 689, 706,
     720, 727)
...
equation = 'y=' + str(para[0]) + '*\nln[-' + str(para[1]) + 'a^2\n+' + str(
    para[2]) + 'a\n+' + str(para[3]) + ']\n+' + str(para[4])
plt.title("PQ line in iron-carbon phase diagram, but in at.%", fontsize=18)
